      ...
      <S.ProfileInfo>
              ...
              <S.DateSelect>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <S.SelectDate
                      title="Năm"
                      options={range(1990, 2022).map(item => ({
                        name: item,
                        value: item
                      }))}
                      onChange={field.onChange}
        ...
        <S.ProfileRight>
          <S.AvatarUploader>
            <S.Avatar>
              <img
                src="https://scontent.fsgn4-1.fna.fbcdn.net/v/t39.30808-6/273942873_3212747319046391_2073634045807692331_n.jpg?_nc_cat=103&ccb=1-5&_nc_sid=174925&_nc_ohc=mTkMvy6SrMAAX_uV1ft&_nc_ht=scontent.fsgn4-1.fna&oh=00_AT8OMTxNmxS9wLjQNzSarWictQKHbOgVT32WPoglLcp5fA&oe=6269551B"
                alt=""
              />
            </S.Avatar>
