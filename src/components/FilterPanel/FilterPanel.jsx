...
export default function FilterPanel({ categories, filters }) {
  ...
  const {
    ...
    // thuộc tính để set lần click button
    // khi nhập giá trị đúng thì sẽ tắt thông báo lỗi
    // dùng clearErrors để clear error khi nhập vào input
  ...
  // sử dụng useEffect Để cập nhật lại giá từ thấp đến cao
  // vì khi refresh sẽ trở về giá trĩ default ban đầu
  useEffect(() => {
          ...
          <S.CategoryItem key={category._id}>
            ...
            <NavLink
              ...
              isActive={(match, location) => {
                ...
                // dùng query-string parse ?category=60aba4e24efcc70f8892e1c6
                // thành category: "60aba4e24efcc70f8892e1c6"
                // nếu dùng querystring sẽ k bỏ dấu chấm hỏi
      ...
      <S.FilterGroup>
        ...
        <S.PriceRange>
          ...
          {Object.values(errors).length !== 0 && (
            <S.PriceErrorMessage>Vui lòng đến khoảng giá phù hợp</S.PriceErrorMessage>
          )}
